...
public class MultidimensionalArrayByNewExample {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < englishScores.length; i++) {    // 반의 수만큼 반복
            for (int j = 0; j < englishScores[i].length; j++) {     // 해당 반의 수만큼 반복
                System.out.println("enlgishScores[" + i +"][" + j + "] : " + englishScores[i][j]);
            }
        }
        System.out.println();

        // 배열 항목 값 변경
        englishScores[0][0] = 75;
        englishScores[0][1] = 80;
        englishScores[1][0] = 65;
        englishScores[1][1] = 70;
        ...
        for (int i = 0; i < englishScores.length; i++) {  // 반의 수만큼 반복
            ...
            for (int j = 0; j < englishScores[i].length; j++) {  // 해당 반의 학생 수 만큼 반복
